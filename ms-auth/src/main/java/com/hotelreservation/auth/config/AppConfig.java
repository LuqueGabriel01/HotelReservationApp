 ...
 * <p>
 * This class defines the necessary beans for user retrieval, password encoding,
 * and authentication management across the security filters.
 * </p>
 *
...
public class AppConfig {
    ...
    /**
     * Data access object (DAO) provider that leverages the custom {@link UserDetailsService}
     * and {@link PasswordEncoder} to authenticate credentials.
     *
     ...
     * <p>
     * The AuthenticationManager is responsible for processing authentication requests in the application controllers.
     * </p>
     *
