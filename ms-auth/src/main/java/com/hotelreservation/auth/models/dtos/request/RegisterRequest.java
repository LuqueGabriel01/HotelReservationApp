 ...
 * <p>
 * This record captures the required credentials and profile information
 * to create and persist a new user account within the system.
 * </p>
 *
 * @param username
 * @param password {@link ValidPassword}
