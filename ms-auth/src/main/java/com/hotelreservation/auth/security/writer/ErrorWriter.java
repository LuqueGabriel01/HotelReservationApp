 ...
 * stream.
 *
 * <p>This helper is mainly utilized by security handlers and filters to bypass the standard Spring
 * MVC ExceptionHandler infrastructure when dispatching auth-related errors.
 */
@Component
