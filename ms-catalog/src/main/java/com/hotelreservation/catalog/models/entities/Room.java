...
@Table(
    name = "rooms",
    indexes = {@Index(name = "idx_room_type_capacity", columnList = "type, capacity")})
@Getter
@NoArgsConstructor
public class Room extends AuditableEntity {
   ...
   */
  public Room(
      Hotel hotel, RoomType type, BigDecimal pricePerNight, int capacity, String description) {
    this.hotel = hotel;
    this.type = type;
  ...
  /**
   * Business logic domain method to safely process partial updates onto fields based on non-null
   * parameters.
   *
   ...
   */
  public void update(
      RoomType type, BigDecimal pricePerNight, Integer capacity, String description) {
    if (type != null) {
      this.type = type;
    }
