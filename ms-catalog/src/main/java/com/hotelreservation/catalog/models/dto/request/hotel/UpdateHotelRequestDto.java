...
/**
 * Data transfer object representing the request payload to update an existing hotel record. All
 * fields are optional to allow partial updates while maintaining validation limits.
 */
