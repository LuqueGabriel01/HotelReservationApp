...
public class RoleInterceptor implements HandlerInterceptor {
  ...
  private static final List<String> ADMIN_ONLY_METHODS = List.of("POST", "PUT", "PATCH", "DELETE");

  /**
   * Intercepts HTTP requests before they reach the controller. Checks if write operations are
   * authorized by validating the presence and value of the required role header.
   *
