...
/** REST controller endpoints managing hotel persistence, catalog queries, and administration. */
@RestController
@RequiredArgsConstructor
@Tag(name = "Hotel controller", description = "Endpoints for hotel persistence ")
...
public class HotelController {
   ...
   * @param stars filter stars
   * @param amenityNames filter amenities
  ...
  public ResponseEntity<PageResponseDto<HotelSummaryResponseDto>> getAllHotels(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(hotelService.findAllHotels(filterRequest, page, size));
  }
  ...
  public ResponseEntity<CreateHotelResponseDto> createHotel(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              ...
              required = true,
              content = @Content(schema = @Schema(implementation = CreateHotelRequestDto.class)))
          @RequestBody
          @Valid
          CreateHotelRequestDto newHotel) {
  ...
  public ResponseEntity<UpdateHotelResponseDto> updateHotel(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              ...
              required = true,
              content = @Content(schema = @Schema(implementation = UpdateHotelRequestDto.class)))
          @RequestBody
          UpdateHotelRequestDto updatedHotel,
      @Parameter(
              description = OpenApiConstants.Example.HOTEL_UUID,
              example = OpenApiConstants.Example.EXAMPLE_UUID)
          @PathVariable
