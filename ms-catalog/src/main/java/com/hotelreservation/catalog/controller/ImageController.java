...
public class ImageController {
    ...
    @Operation(
            summary = "Upload hotel photos",
            description = "Uploads hotel photos. ADMIN only."
    )
    @ApiResponses({
            @ApiResponse(
    ...
    public ResponseEntity<List<ImageHotelResponseDto>> uploadImages(
            ...
            @RequestPart @Valid List<MultipartFile> photos
            ) throws IOException {
        return ResponseEntity.status(HttpStatus.CREATED).body(imageService.uploadImages(hotelId, photos));
    }
    ...
    public ResponseEntity<Void> deleteImage(
            ...
            @Parameter(description = "Image UUID", example = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
