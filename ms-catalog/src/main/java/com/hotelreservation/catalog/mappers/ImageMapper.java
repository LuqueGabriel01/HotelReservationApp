...
/**
 * MapStruct mapper component responsible for converting ImageHotel domain entities
 * into their corresponding data transfer object response profiles.
 */
@Mapper(componentModel = "spring")
public interface ImageMapper {

    /**
     * Transforms an ImageHotel entity into an ImageHotelResponseDto.
     * Maps the status of the main image flag explicitly onto the destination record field.
     *
