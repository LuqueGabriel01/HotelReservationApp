...
public class HotelSpecification {
    ...
    /**
     * Creates a specification to filter hotels that possess any of the specified amenities.
     * Applies a distinct modifier to prevent duplicate rows in the resulting join dataset.
     *
